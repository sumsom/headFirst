...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://wsTest/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://wsTest/", "queryWeatherResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsTest/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wsTest/", name = "queryWeatherResponse")
